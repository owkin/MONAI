...
if __name__ == "__main__":
    ...
    parser.add_argument('--n-train-data-samples',
                        type=int,
                        default=40,
                        help="Number of train data samples to generate")
    parser.add_argument('--n-test-data-samples',
                        type=int,
                        default=5,
                        help="Number of test data samples to generate")
